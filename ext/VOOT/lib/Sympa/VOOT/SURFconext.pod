...
=head2 Setting-up a test VOOT server
...
=item I<profile> is "Web Application".
...
be something like
  ...
  https://[your-sympa-hostname]/oauth2_ready/surfconext-test/[identifier]
...
=item Set I<Allowed Scope> to "read"
...
=head2 Setting up the "live" server
...
be something like
  ...
  https://[your-sympa-hostname]/oauth2_ready/surfconext/[identifier]
