...
[FOREACH p IN param]
 [IF p->may_edit<>hidden]
  ...
  <A HREF="[path_cgi]/help/editlist#[p->name]" onClick="window.open('','wws_help','toolbar=no,location=no,directories=no,status=no,menubar=no,scrollbars=yes,resizable=yes,copyhistory=no,width=640,height=200')" TARGET="wws_help"  ><FONT SIZE="-1">幫助</FONT></A>
  </TH></TR></TABLE>
  ...
  [IF p->default=1]
    <FONT COLOR="[bg_color]"><B>預設</B></FONT>
  [ENDIF]
...
<INPUT TYPE="submit" NAME="action_edit_list" VALUE="更新">
</FORM>
[ENDIF]
