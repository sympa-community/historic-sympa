...
<TD VALIGN="top" NOWRAP>
    <FORM ACTION="[path_cgi]" METHOD="POST">
      ...
      <INPUT TYPE="submit" NAME="action_add" VALUE="新增> 安靜<INPUT TYPE="checkbox" NAME="quiet">
    </FORM>
</TD>
<TD>
   ...
   <TABLE BORDER="0" WIDTH="100%" CELLSPACING="1" CELLPADDING="2" VALIGN="top">
     <TR>
       <TD BGCOLOR="[light_color]" ALIGN="center" VALIGN="top">
         ...
         <A HREF="[path_cgi]/add_request/[list]" ><b>新增個</b></A>
         </FONT>
       </TD>
     </TR>
   </TABLE></TD></TR>
   ...
   <TABLE BORDER="0" WIDTH="100%" CELLSPACING="1" CELLPADDING="2" VALIGN="top">
     <TR>
       <TD BGCOLOR="[light_color]" ALIGN="center" VALIGN="top">
         ...
         <A HREF="[path_cgi]/remind/[list]" onClick="request_confirm_link('[path_cgi]/remind/[list]', '您確定要給全部的[total]個訂閱者發送訂閱提醒郵件嗎?'); return false;"><b>提醒全部訂閱者</b></A>
...
<TABLE WIDTH="100%" BORDER="0">
  ...
  [IF is_owner]
    ...
    <INPUT TYPE="submit" NAME="action_del" VALUE="刪除選中的郵件地址">
  ...
  <TD NOWRAP>
	...
	<INPUT TYPE="submit" NAME="action_review" VALUE="頁面大小">
	        <SELECT NAME="size">
   ...
   <TD>
   [IF prev_page]
    <A HREF="[path_cgi]/review/[list]/[prev_page]/[size]/[sortby]"><IMG SRC="[icons_url]/left.png" BORDER=0 ALT="前一頁"></A>
   [ENDIF]
   [IF page]
     [page]/[total_page]
   [ENDIF]
   [IF next_page]
     <A HREF="[path_cgi]/review/[list]/[next_page]/[size]/[sortby]"><IMG SRC="[icons_url]/right.png" BORDER="0" ALT="後一頁"></A>
   [ENDIF]
  [ENDIF]
  </TD></TR>
  </TABLE>
	...
	[ENDIF]
	    ...
	    <FONT COLOR="[bg_color]" SIZE="-1"><b>電子郵件</b></FONT>
	[ELSE]
	    <TH NOWRAP COLSPAN=2>
	    <A HREF="[path_cgi]/review/[list]/1/[size]/email" >
	    <FONT SIZE="-1"><b>電子郵件</b></A>
	[ENDIF]
	</TH>
