...
<MENU>
<INPUT TYPE="radio" NAME="status" VALUE="closed">關閉它 &nbsp;&nbsp;
<INPUT TYPE="radio" NAME="status" VALUE="open">安裝它 &nbsp;&nbsp;
</MENU>
</TD>
<TD>
<INPUT TYPE="submit" NAME="action_install_pending_list" VALUE="確認">
<INPUT TYPE="checkbox" NAME="notify" CHECKED>告知擁有者
</FORM>
</TD>
</TR>
</TABLE>
