...
## Parameter names refer to the %in structure of to $param if mentioned as 'param.x'
...
sub do_ticket {
    ...
    # if the ticket is related to someone who is not logged in, the system  performs the same operation as for a login
