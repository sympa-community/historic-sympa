    ...
    my %full_db_struct = (
        ...
        'spool_table' => {
            'fields' => {
                ...
                'spoolname_spool' => {
                    'struct' =>
                        "enum('msg','auth','mod','digest','archive','bounce','subscribe','topic','bulk','validated','task')",
                    'doc'      => 'the spool name',
                    'not_null' => 1,
                    'order'    => 2,
                },
                ...
                'lockdate_spool' => {
                    'struct' => 'int(11)',
                    'doc' =>
                        'the date a lock is set. Used in order detect old locks',
                    'order' => 9,
                },
                ...
                'subject_spool' => {
                    'struct' => 'varchar(110)',
                    'doc' =>
                        'subject of the message stored to list spool content faster',
                    'order' => 16,
                },
                'sender_spool' => {
                    'struct' => 'varchar(110)',
                ...
                'task_flavour_spool' => {
                    'struct' => 'varchar(60)',
                    'doc' =>
                        'the declinaison of the model used with this task',
                    'order' => 24,
                },
                'task_object_spool' => {
                    'struct' => 'varchar(50)',
                ...
                'message_spool' => {
                    ...
                    'order' =>
                        99,  # long field should be the last column on Oracle.
                },
            },
            'doc' =>
                'This table is created in version 6.2. It replace most of spools on file system for clustering purpose',
            'order' => 3,
        },
        'bulkpacket_table' => {
            'fields' => {
                'messagekey_bulkpacket' => {
                    'struct' => 'bigint(20)',
                    'doc' =>
                        'A pointer to a message in spool_table.  It must be a value of a line in table spool_table with same value as messagekey_spool',
                    'primary'  => 1,
                    'not_null' => 1,
                    'order'    => 1,
                },
                ...
                'tracking_bulkpacket' => {
                    'struct' => "enum('mdn','dsn')",
                    'doc' =>
                        'Is DSN or MDM requiered when sending this message?',
                    'order' => 9,
                },
                'merge_bulkpacket' => {
                    'struct' => 'int(1)',
                ...
                'lock_bulkpacket' => {
                    'struct' => 'varchar(30)',
                    'doc' =>
                        'A lock. It is set as process-number @ hostname so multiple bulk mailers can handle this spool',
                    'order' => 15,
                },
            },
            'doc' =>
        ...
        'admin_table' => {
            'fields' => {
                ...
                'reception_admin' => {
                    'struct' => 'varchar(20)',
                    'doc' =>
                        'email reception option for list managment messages',
                    'order' => 8,
                },
                'visibility_admin' => {
                    'struct' => 'varchar(20)',
