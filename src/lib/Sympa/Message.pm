...
sub _personalize_entity {
	...
	return $entity;
    } elsif (MIME::Sympa::Tools::textual_type($eff_type)) {
...
sub prepare_reception_urlize {
    ...
    my $dir1 =
	Sympa::Tools::clean_msg_id($self->get_mime_message->head->get('Message-ID'));
...
sub _urlize_part {
	...
	Sympa::Tools::escape_chars("$dir/$filename", '/'); # do NOT escape '/' chars
