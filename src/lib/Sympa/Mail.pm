...
sub mail_message {
	...
	$rcpt_by_dom{$dom} += 1 ;
	&Sympa::Log::do_log('debug2', "domain: $dom ; rcpt by dom: $rcpt_by_dom{$dom} ; limit for this domain: $Sympa::Conf::Conf{'nrcpt_by_domain'}{$dom}");
...
##  of Unicode string (parent message generated by Sympa::TT2::parse_tt2()) and byte string (sub-messages).
##
