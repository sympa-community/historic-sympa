...
sub probe_db {
    ...
    my %db_struct = ('mysql' => {'user_table' => {'email_user' => 'varchar(100)',
				 ...
				 'spool_table' => {'messagekey_spool' => 'varchar(33)',
						   'spoolname_spool' => "enum('auth', 'bad', 'bounce', 'digest', 'bulk', 'expire', 'moderation', 'msg', 'outgoing', 'subscribe', 'topic')",
						   'list_spool' =>'varchar(50)',
						   'robot_spool' =>'varchar(80)',
						   'receptiondate_spool' => 'int(11)',
						   'priority_spool' => 'smallint(6)',
						   'sender_spool' => 'varchar(120)',
						   'subject_spool' => 'varchar(120)',
						   'messageid_spool' => 'varchar(100)',
						   'size_spool' => 'int',
